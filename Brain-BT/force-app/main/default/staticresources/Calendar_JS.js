...
{
   $(".fc-body").on('mouseenter', 'td', function (e) {
$('.btn-click').remove();
$('<a title="Hello" class="btn-click">Click</a>').appendTo($(this));
});
...
$(document).ready(function() {
   ...
   var calendar = $('#calendar').fullCalendar({
         ...
         if(event.allDay == false){
          ...
          element.popover({
           ...
           if (event.username == "Caio Vitorelli") {
               element.css('background-color', '#3a8ed8');
           }
           if (event.username == "Peter Grant") {
               element.css('background-color', '#1756ff');
           }
           if (event.username == "Adam Rackham") {
               element.css('background-color', '#21649e');
           }
           if (event.username == "Roofing") {
           ...
           var types = $('#type_filter,#type_filters,#type_filterss').val();
    ...
    '</ul>';
       ...
       events: [{
           ...
           start: '2021-01-07T09:30',
           end: '2021-01-07T10:00',
           type: 'Project',
           calendar: 'Sales',
           className: 'colorAppointment',
           username: 'Caio Vitorelli',
           backgroundColor: "#3a8ed8",
           textColor: "#ffffff",
           allDay: false
       }, {
           _id: 2,
           ...
           avatar: '',
           description: 'Lorem ipsum dolor sit incid idunt ut Lorem ipsum sit.',
           start: '2021-01-01T12:30',
           end: '2021-01-01T15:30',
           type: 'Project',
           calendar: 'Sales',
           className: 'colorAppointment',
           username: 'Adam Rackham',
           backgroundColor: "#21649e",
           textColor: "#ffffff",
           allDay: false
       }, {
           _id: 3,
   ...
   $("#type_filter, #type_filters, #type_filterss").select2({
...
$(".fc-body").on('mouseenter', '.fc-day', function (e) {
$('.btn-click').remove();
$(".fc-day-top[data-date='" + $(this).attr('data-date') + "']").append('<a title="Hello" class="btn-click"><span class="glyphicon glyphicon-plus"></span></a>');
// $('<a title="Hello" class="btn-click"><span class="glyphicon glyphicon-plus"></span></a>').appendTo($(this));
});
$(document).on('click', '.btn-click', function () {
$('#exampleModal').modal('show');
});
$(".fc-body").on('mouseenter', '.fc-day-top', function (e) {
$('.btn-click').remove();
$(this).append('<a title="Hello" class="btn-click"><span class="glyphicon glyphicon-plus"></span></a>');
// $('<a title="Hello" class="btn-click"><span class="glyphicon glyphicon-plus"></span></a>').appendTo($(this));
});
$(document).on('click', '.btn-click', function () {
$('#exampleModal').modal('show');
